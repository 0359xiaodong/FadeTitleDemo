...
public class ParallaxScrollView extends ScrollView {
    ...
    private void resetView() {
        ...
        if (!normal.isEmpty()) {
            ...
            contentRsetAnimation.setAnimationListener(new Animation.AnimationListener() {
            ...
            //缩放动画
            scaleResetAnimation = new ParallaxTransformResetAnimation(mParallaxView, parallaxViewHeight, parallaxViewWidth);
    ...
    public class ParallaxTransformResetAnimation extends Animation {
         ...
         */
        protected ParallaxTransformResetAnimation(View view, int targetHeight, int targetWidth) {
            this.mView = view;
